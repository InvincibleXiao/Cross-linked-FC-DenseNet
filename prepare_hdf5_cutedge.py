...
data_path = './iSeg-2019-Training/iSeg-2019-Training'
#Saved path
...
def build_h5_dataset(data_path, target_path):
    ...
    for i in range(0, 10):
        ...
        #labels=np.zeros(img_T1.shape) # an cai nay hai tren hien, va hai tren an se hien cai nay và 11 -23
        ...
        print(inputs_caffe.shape, labels_caffe.shape, inputs_caffe.min(), inputs_caffe.max(), labels_caffe.min(),
              labels_caffe.max(), '====================')
